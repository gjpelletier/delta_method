# -*- coding: utf-8 -*-
"""delta_method_sigmoid4_v26.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jY4DTfONJ1Z9OaqWNY7bk_gQZquivcuV
...
"""The best-fit values of the model parameters from lmfit can now be extracted into a numpy array that we named "param" from the lmfit results as follows:"""

param=np.array(out.params)
param

"""The variance-covariance matrix of the model parameters from lmfit can be extracted into a numpy array that we name "COVB" as follows:"""
...
# Next we will make a numpy array of the initial paramter values to use with scipy.
# Note that the guesses need to be approximately the same order of magnitude as the optimum values
A_init_ = 90
gamma_init_ = 2
tau_init_ = 2
S_init_ = 50
param0 = np.array([A_init_, gamma_init_, tau_init_, S_init_])
