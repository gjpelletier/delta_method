# -*- coding: utf-8 -*-
"""delta_method_sigmoid4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GmhMIPaKZgH1lyOIB8Jh0GAnOSxYqFr8
...
The lmfit package is used to find the best-fit values and the variance-covariance matrix of the model parameters. 
The user may specify any expression for the nonlinear regression model. The lmfit package is described at the following link:

https://lmfit.github.io//lmfit-py/index.html

In this example we use a 4-parameter logistic function with a sigmoid shape to fit an observed data set. 
The data set that we use provided by the R base package datasets, and consist of the 
...
Yellowstone National Park, Wyoming, USA. In this example, 
...
"""Now we can build set the initial parameter values as follows using guesses for the 
inital parameter values of A=90, gamma=2, tau=2, S=50:"""
