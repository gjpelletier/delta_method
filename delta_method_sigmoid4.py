# -*- coding: utf-8 -*-
"""delta_method_sigmoid4_v28b10.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1n6Kgin_FTzIs4P1cwIdGeUSGe9yWfXZO
...
print("")
print("Parameter \t beta_hat \t se_lin \t t_stat \t Pr(>|t|) \t 95% confidence intervals")
print("A:        \t %.4f     \t %.4f   \t %.4f   \t %.1e    \t (%.4f - %.4f)" % (popt[0], se_lin[0], t_stat[0], pval[0], lwr_ci[0], upr_ci[0]))
print("gamma:    \t %.4f     \t %.4f   \t %.4f   \t %.1e    \t (%.4f - %.4f)" % (popt[1], se_lin[1], t_stat[1], pval[1], lwr_ci[1], upr_ci[1]))
print("tau:      \t %.4f     \t %.4f   \t %.4f   \t %.1e    \t (%.4f - %.4f)" % (popt[2], se_lin[2], t_stat[2], pval[2], lwr_ci[2], upr_ci[2]))
print("S:        \t %.4f     \t %.4f   \t %.4f   \t %.1e    \t (%.4f - %.4f)" % (popt[3], se_lin[3], t_stat[3], pval[3], lwr_ci[3], upr_ci[3]))