...
The user has the option to plot either scaled or unscaled KDE values. We use scaled KDE values in this example, and we mask values below a threshold of 0.001. The user has the option to select any threshold value for masking.
