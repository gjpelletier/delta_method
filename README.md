...
We introduce the following new functions to estimate confidence intervals and prediction intervals for nonlinear regression, and plot contours of scaled or un-scaled Kernel Density Estimates (KDE):
