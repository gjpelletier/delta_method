# -*- coding: utf-8 -*-
"""delta_method_asympt3_v27.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CjJ2ZjCAdzul1tVe0exfjnziwqtirX3o
...
"""Before using the delta_method function, we first need to make a few more inputs for it as follows (NOTE: make sure the lambda function f below matches the ExpressionModel function defined earlier):"""
...
b2_init_ = -1e6
b3_init_ = -10
p_init_ = np.array([b1_init_, b2_init_, b3_init_])

# Now we are ready to find best fit parameter array (popt_) and variance-covariance matrix (pcov_) from scipy
...
b2str_ = '%.3e' %popt_[1]
b3str_ = '%.3e' %popt_[2]
eqnstr_ = 'y = ' + b2str_ + ' exp(' + b3str_ + ' * x) + ' + b1str_
...
plt.xlabel('x= TA:DIC')
plt.ylabel('y= calcification rate (mmol/g/hr)')
plt.text(1.0, -.0004, eqnstr_, fontsize = 9)
plt.text(1.0, -.00045, 'r^2 = '+ rsqstr_ +', p = '+ pstr_, fontsize = 9)
# plt.ticklabel_format(style='plain', axis='y')
plt.ticklabel_format(style='sci', axis='y', scilimits=(0,0))